...
utilizing custom tools for running SQL queries and describing table schemas.
...
# Create an AgentExecutor to execute the agent with verbose logging and conversation memory
